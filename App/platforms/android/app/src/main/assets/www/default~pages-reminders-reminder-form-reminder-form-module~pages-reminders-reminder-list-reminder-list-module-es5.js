(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-reminders-reminder-form-reminder-form-module~pages-reminders-reminder-list-reminder-list-module"], {
    ...
    /***/
    function kPTf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ReminderFormPage", function () {
        return ReminderFormPage;
      });
      /* harmony import */


      var _services_v1_reminder_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      function ReminderFormPage_p_12_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ReminderFormPage_p_18_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "p", 17);
      ...
      function ReminderFormPage_ion_progress_bar_39_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelement"](0, "ion-progress-bar", 18);
        }
      }

      var ReminderFormPage = /*#__PURE__*/function () {
        function ReminderFormPage(reminderService, formBuilder, modalController) {
          _classCallCheck(this, ReminderFormPage);
        ...
        return _createClass(ReminderFormPage, [{
          key: "ngOnInit",
          ...
          key: "storeReminder",
          value: function storeReminder() {
            var _this = this;

            this.submitting = true;
            var body = this.setBody();
            this.reminderService.storeReminder(body).subscribe(function (response) {
          ...
          key: "updateReminder",
          value: function updateReminder() {
            var _this2 = this;

            this.submitting = true;
            var body = this.setBody();
            this.reminderService.updateReminder(this.reminder, body).subscribe(function (response) {
      ...
      ReminderFormPage.ɵfac = function ReminderFormPage_Factory(t) {
        return new (t || ReminderFormPage)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_services_v1_reminder_service__WEBPACK_IMPORTED_MODULE_0__["ReminderService"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"]));
      };

      ReminderFormPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        type: ReminderFormPage,
        ...
        decls: 42,
        vars: 5,
        consts: [["slot", "end"], ["name", "close", 1, "font-2em", 3, "click"], [3, "formGroup"], [1, "form-group"], ["formControlName", "description"], ["class", "ion-no-margin form-error-message", 4, "ngIf"], ["lines", "none", 1, "custom-item"], ["displayFormat", "DD MMMM YYYY", "formControlName", "date", "doneText", "ok", "cancelText", "cancelar", "monthNames", "enero, febrero, marzo, abril, mayo, junio, julio, agosto, septiembre, octubre, noviembre, diciembre", "monthShortNames", "ene, feb, mar, abr, may, jun, jul, ago, sep, oct, nov, dic", "dayNames", "domingo, lunes, martes, mi\xE9rcoles, jueves, viernes, s\xE1bado, domingo", "dayShortNames", "dom, lun, mar, mi\xE9, jue, vie, s\xE1b, dom"], ["formControlName", "type"], ["lines", "none"], ["value", "once"], ["value", "monthly"], ["value", "semi_annually"], ["value", "yearly"], [1, "ion-text-center", "ion-margin-bottom"], ["type", "indeterminate", 4, "ngIf"], [1, "custom-button", 3, "disabled", "click"], [1, "ion-no-margin", "form-error-message"], ["type", "indeterminate"]],
        template: function ReminderFormPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function ReminderFormPage_Template_ion_icon_click_3_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](10, "Descripci\xF3n");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](36, "Una vez al a\xF1o");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function ReminderFormPage_Template_ion_button_click_40_listener() {
              return ctx.submit();
            });
    ...
    /***/
    function rvaX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ReminderService = /*#__PURE__*/function () {
        ...
        return _createClass(ReminderService, [{
          key: "getReminders",
          value: function getReminders() {
            return this.http.get("".concat(this.API_URL).concat(this.V1, "reminders"));
          }
        }, {
          key: "storeReminder",
          value: function storeReminder(body) {
            return this.http.post("".concat(this.API_URL).concat(this.V1, "reminders"), body);
          }
        }, {
          key: "updateReminder",
          value: function updateReminder(reminder, body) {
            return this.http.post("".concat(this.API_URL).concat(this.V1, "reminders/").concat(reminder.id), body);
          }
        }, {
          key: "deleteReminder",
          value: function deleteReminder(reminder) {
            return this.http["delete"]("".concat(this.API_URL).concat(this.V1, "reminders/").concat(reminder.id));
          }
        }]);
      }();

      ReminderService.ɵfac = function ReminderService_Factory(t) {
        return new (t || ReminderService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
      };

      ReminderService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
...
//# sourceMappingURL=default~pages-reminders-reminder-form-reminder-form-module~pages-reminders-reminder-list-reminder-list-module-es5.js.map