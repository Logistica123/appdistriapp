(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-ranking-ranking-module"], {
    ...
    function Bw(module, __webpack_exports__, __webpack_require__) {
      ...
      var _ranking_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./ranking-routing.module */
      "IEeq");
      /* harmony import */


      var _ranking_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./ranking.page */
      "tdSZ");
      /* harmony import */
      ...
      var RankingPageModule = /*#__PURE__*/_createClass(function RankingPageModule() {
        _classCallCheck(this, RankingPageModule);
      });

      RankingPageModule.ɵfac = function RankingPageModule_Factory(t) {
        return new (t || RankingPageModule)();
      };

      RankingPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineNgModule"]({
        type: RankingPageModule
      });
      RankingPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjector"]({
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"], _ranking_routing_module__WEBPACK_IMPORTED_MODULE_3__["RankingPageRoutingModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵsetNgModuleScope"](RankingPageModule, {
          declarations: [_ranking_page__WEBPACK_IMPORTED_MODULE_4__["RankingPage"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"], _ranking_routing_module__WEBPACK_IMPORTED_MODULE_3__["RankingPageRoutingModule"]]
        });
      })();
      /***/
    ...
    /***/
    function IEeq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _ranking_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./ranking.page */
      "tdSZ");
      /* harmony import */
      ...
      var RankingPageRoutingModule = /*#__PURE__*/_createClass(function RankingPageRoutingModule() {
        _classCallCheck(this, RankingPageRoutingModule);
      });

      RankingPageRoutingModule.ɵfac = function RankingPageRoutingModule_Factory(t) {
        return new (t || RankingPageRoutingModule)();
      };

      RankingPageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
        type: RankingPageRoutingModule
      });
      RankingPageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](RankingPageRoutingModule, {
    ...
    /***/
    function tdSZ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _services_v2_driver_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      function RankingPage_ion_content_6_img_6_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function RankingPage_ion_content_6_img_7_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "img", 14);
        }
      }

      function RankingPage_ion_content_6_img_15_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "img", 13);
        }
      ...
      function RankingPage_ion_content_6_img_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "img", 14);
        }
      }

      function RankingPage_ion_content_6_img_22_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "img", 13);
        }
      ...
      function RankingPage_ion_content_6_img_23_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "img", 14);
        }
      }

      function RankingPage_ion_content_6_ion_list_28_ion_item_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function RankingPage_ion_content_6_ion_list_28_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function RankingPage_ion_content_6_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ionRefresh", function RankingPage_ion_content_6_Template_ion_refresher_ionRefresh_1_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r12);

            var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

            return ctx_r11.doRefresh($event);
          });
      ...
      var RankingPage = /*#__PURE__*/function () {
        function RankingPage(driverService, domSanitizer) {
        ...
        return _createClass(RankingPage, [{
          key: "ngOnInit",
          ...
          value: function getRanking() {
            ...
            this.loading = true;
            this.driverService.getRanking().subscribe(function (response) {
              _this.drivers = response.drivers;
              _this.podium = response.podium;
              _this.list = response.list;

              if (_this.podium.length >= 1) {
                _this.getPodium0DriverProfileImage(_this.podium[0]);
              }

              if (_this.podium.length >= 2) {
                _this.getPodium1DriverProfileImage(_this.podium[1]);
              }

              if (_this.podium.length >= 3) {
                _this.getPodium2DriverProfileImage(_this.podium[2]);
              }
          ...
          key: "getPodium0DriverProfileImage",
          value: function getPodium0DriverProfileImage(driver) {
            var _this2 = this;

            this.driverService.getDriverProfileImage(driver).subscribe(function (blob) {
              var objectURL = URL.createObjectURL(blob);
              _this2.podium0ProfileImage = _this2.domSanitizer.bypassSecurityTrustUrl(objectURL);
            });
          }
        }, {
          key: "getPodium1DriverProfileImage",
          value: function getPodium1DriverProfileImage(driver) {
            var _this3 = this;

            this.driverService.getDriverProfileImage(driver).subscribe(function (blob) {
              var objectURL = URL.createObjectURL(blob);
              _this3.podium1ProfileImage = _this3.domSanitizer.bypassSecurityTrustUrl(objectURL);
            });
          }
        }, {
          key: "getPodium2DriverProfileImage",
          value: function getPodium2DriverProfileImage(driver) {
            var _this4 = this;

            this.driverService.getDriverProfileImage(driver).subscribe(function (blob) {
              var objectURL = URL.createObjectURL(blob);
              _this4.podium2ProfileImage = _this4.domSanitizer.bypassSecurityTrustUrl(objectURL);
            });
          }
        }, {
          key: "doRefresh",
      ...
      RankingPage.ɵfac = function RankingPage_Factory(t) {
        return new (t || RankingPage)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_services_v2_driver_service__WEBPACK_IMPORTED_MODULE_0__["DriverService"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["DomSanitizer"]));
      };

      RankingPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        type: RankingPage,
        selectors: [["app-ranking"]],
        decls: 7,
        vars: 1,
        consts: [[1, "ion-no-border"], ["slot", "start"], ["autoHide", "false"], [4, "ngIf"], ["slot", "fixed", 3, "ionRefresh"], ["size", "4", 1, "ion-text-center", "mt-80"], ["alt", "", 3, "src", 4, "ngIf"], ["src", "assets/images/default_profile_img.png", "alt", "", 4, "ngIf"], [1, "podium-driver-score"], [1, "ion-no-margin", "driver-podium-name"], ["size", "4", 1, "ion-text-center"], ["src", "assets/images/crown.png", "alt", "", 1, "crown"], ["lines", "none", 4, "ngIf"], ["alt", "", 3, "src"], ["src", "assets/images/default_profile_img.png", "alt", ""], ["lines", "none"], [3, "--animation-order", 4, "ngFor", "ngForOf"], [1, "ion-align-self-center"], [1, "driver-name"], ["size", "3", 1, "ion-text-right", "ion-align-self-center"], [1, "driver-score"]],
        template: function RankingPage_Template(rf, ctx) {
          if (rf & 1) {
...
//# sourceMappingURL=pages-ranking-ranking-module-es5.js.map