...
/* harmony import */ var _services_v2_transaction_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../services/v2/transaction.service */ "5fqc");
...
class WalletWithdrawalRequestFormPage {
    constructor(formBuilder, transactionService, modalController) {
...
WalletWithdrawalRequestFormPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: WalletWithdrawalRequestFormPage, selectors: [["app-wallet-withdrawal-request-form"]], decls: 31, vars: 5, consts: [["slot", "end"], ["name", "close", 1, "font-2em", 3, "click"], [1, "ion-text-center"], [3, "formGroup"], [1, "form-group"], ["formControlName", "type"], ["value", "adelanto"], ["value", "retiro"], ["class", "ion-no-margin form-error-message", 4, "ngIf"], ["type", "number", "formControlName", "amount", "inputmode", "number"], [1, "ion-padding"], ["type", "indeterminate", 4, "ngIf"], [1, "custom-button", 3, "disabled", "click"], [1, "ion-no-margin", "form-error-message"], ["type", "indeterminate"]], template: function WalletWithdrawalRequestFormPage_Template(rf, ctx) { if (rf & 1) {
...
//# sourceMappingURL=default~pages-wallet-wallet-withdrawal-request-form-wallet-withdrawal-request-form-module~wallet-tra~7a323ccd-es2015.js.map