...
/* harmony import */ var _services_v2_driver_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/v2/driver.service */ "5YAf");
...
class RegisterPage {
    constructor(formBuilder, router, driverService) {
...
RegisterPage.ɵfac = function RegisterPage_Factory(t) { return new (t || RegisterPage)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_services_v2_driver_service__WEBPACK_IMPORTED_MODULE_1__["DriverService"])); };
RegisterPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: RegisterPage, selectors: [["app-register"]], decls: 20, vars: 2, consts: [[1, "ion-no-border"], ["mode", "ios"], ["slot", "start"], ["color", "dark", "defaultHref", "login"], ["color", "primary"], [1, "content"], [3, "formGroup"], [1, "form-group"], ["type", "text", "placeholder", "Nombre", "formControlName", "name"], ["type", "text", "placeholder", "Correo electr\u00F3nico", "formControlName", "email", "inputmode", "email"], ["type", "password", "placeholder", "Contrase\u00F1a", "formControlName", "password"], ["type", "password", "placeholder", "Confirmar contrase\u00F1a", "formControlName", "password_confirmation"], [1, "ion-text-center", "ion-margin"], [3, "disabled", "click"]], template: function RegisterPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function RegisterPage_Template_button_click_18_listener() { return ctx.submit(); });
